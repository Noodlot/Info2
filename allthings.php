    ...
    <body style="height: 100%;">
        <table width="1040" border="0" align="center" cellpadding="0" cellspacing="0" style="height: 100%;">
                ...
                ?>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="allthingsuser.php?id=<?=$row['id']?>"><?=$row['nev']?></a>
                            <?php endwhile; ?>
                        </div>
                    </div>
            ...
            <table width="1040" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr valign="top">
                    <th><p  class='testb' align="center">Új Felhasznalo</p></th>
                </tr>
                <tr valign="top">
                    <td align="center" valign="top" bgcolor="#000000" valign="top">
                        <form action="allthings.php" method="post" bgcolor="#000000">
                            <p class='testb'>
...
<?php
    ...
    if (isset($_POST['uj'])) {
        $link = getDb();
        $nev = $_POST['nev'];
        $query=sprintf("INSERT INTO User(nev) VALUES('%s')", mysqli_real_escape_string($link, $nev));
